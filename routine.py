#THIS IS A PROTOTYPE CODE RAN WITHOUT FLASK USING ONLY PYTHON


print("WELCOME TO DAILY ROUTINE TASK MANAGER")
print("\n THIS SITE ALLOWS YOU TO ADD TASKS AND SET REMINDERS AND A TO DO LIST FOR YOUR DAY")
...
After tracking 2,400 readers through a 30-day sprint, one failure pattern showed up in almost every broken routine. It had nothing to do with willpower or wake-up time. There's a fix, and it takes one afternoon.

See the pattern we found →
Top 5 Rhonda Patrick Routine Products
Clearlight Infrared Sauna — Patrick uses an infrared sauna regularly and has extensively studied heat shock proteins, cardiovascular benefits, and brain health effects of sauna use.
Plunge Cold Plunge — Her cold immersion practice is paired with sauna sessions, using contrast therapy to amplify the benefits of both heat and cold stress.
Nordic Naturals Omega-3 — Patrick is one of the strongest advocates for high-dose omega-3 supplementation, citing its effects on inflammation, brain health, and cardiovascular protection.
Magnesium Glycinate — She emphasizes magnesium as a critical micronutrient involved in over 300 enzymatic reactions, taking it daily for sleep, cognition, and cellular function.
Sulforaphane (from broccoli sprouts) — Patrick grows her own broccoli sprouts and consumes them for their exceptionally high sulforaphane content, one of the most studied activators of the Nrf2 pathway for antioxidant defense.
...
If mornings still feel like surviving, not starting, you're not broken. Your system is.

You've bookmarked productivity articles for years. You've tried the 5 AM club, the bullet journal, the cold shower. Tomorrow you'll hit snooze anyway. That isn't a willpower problem. It's a design problem, and design is fixable, usually in an afternoon.
...
By Brett J. Weiss
Published: 10:40 am PST Oct 6, 2023 | Updated: 12:47 p.m. PST Oct 13, 2023

Highlights

Dr. Sinclair gets at least six hours of sleep per night, preferring seven to eight hours, and sleeps on a bed that lowers his body temperature during the night.
Sinclair rinses his mouth with coconut oil every morning to improve his mouth’s microbial composition.
Sinclair eats a bit of yogurt mixed with plant-derived polyphenolic molecules like resveratrol, drinks one or two green matcha teas and plenty of water throughout the day, and consumes plant-based foods for main meals.
...
Never Too Early to Begin Watching Your Health
...
Shedding Light on Dr. Sinclair’s Daily Eating and Health-Supporting Habits
...
Incorporating a Healthy Exercise Routine
...
Doctor and longevity expert shares 6 daily habits that can add years to life and boost health
...
2. Move more
Here’s the thing. Longevity is not about 60 sweaty minutes in a gym.
  by TaboolaSponsored Links
You May Like
Please save him! I can't watch my child suffer daily.
Donate For Health
It’s about constant movement. Blue Zone research shows the longest-living people rarely “work out.” They walk, they garden, they bend, lift, and stretch all day. No fancy equipment but just bodies in motion. So—don’t sit too long move and then move again.
...
The 4 AM start gives Johnson a training window before his film set or production schedule takes over. It also lets him process the day ahead with no interruptions.

Morning Cardio
Before breakfast, Johnson does 30 to 50 minutes of cardio. This is typically done on a treadmill at a steep incline or on an outdoor track depending on his location.

"First thing in the morning, cardio. I like to get my blood moving and get my head right before I attack the weights."

Why Johnson Does Fasted Cardio
Fasted cardio is performed before the first meal, when glycogen stores are lower. The theory is that the body draws more readily from fat stores for energy in this state.

Johnson's version is low intensity and high duration. This approach burns calories without compromising the muscle tissue he needs for weight training later in the day.

Morning Hydration
Johnson starts his morning with water immediately after waking. He has referenced drinking large amounts of water throughout the day to support his training volume and digestion.

His diet requires substantial fluid intake because of the high protein loads he consumes. Protein digestion and kidney filtration both demand consistent hydration.

Workout
Johnson's main weight training session happens in the morning after cardio. He trains six days per week, rotating through muscle groups with a high-volume approach he calls "Iron Paradise," the name he has given to his gym.

"The Iron Paradise is where I go to find peace. It's 4 AM, it's quiet, it's just me and the weights."
...
Workout Supplements
Afternoon Schedule
Johnson's afternoons are typically occupied by film shoots, production meetings, or business obligations for Teremana and ZOA. He treats his professional commitments with the same discipline he applies to training.

He documents his routine heavily on social media, which also serves as a significant part of his personal brand work. Posting consistency is part of his daily output.

Evening Wind-Down
Johnson is known for going to sleep relatively early given his 4 AM wake time. He has mentioned prioritizing sleep as part of recovery, though his schedule during heavy film production can compress that window.

He does not publicly detail an elaborate wind-down protocol. His recovery focus appears to be centered primarily on his diet and training consistency rather than tech-heavy sleep optimization.

Sleep
Johnson targets around six to eight hours of sleep per night. Given the demands of his physique and training volume, sleep is treated as a recovery tool rather than a luxury.

"Sleep is the most important meal of the day. My body repairs itself at night. I take that seriously.""")

main_choice = input("Enter 1 to view famous routines, 2 to create your own tasks: ")
